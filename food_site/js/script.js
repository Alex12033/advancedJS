window.addEventListener('DOMContentLoaded', () => {
    ...
    new MenuCard(
        ...
        'больше свежих овощей и фруктов. Продукт активных и здоровых людей. Это абсолютно новый продукт' +
        'с оптимальной ценой' + 
        'и высоким качеством!',
        9,
        '.menu .container'
    ...
    new MenuCard(
        ...
        'ресторан! j hvvuovouvuvuo gcvugvvuvuyvuvhiygcyiccccccccccccc',
        14,
        '.menu .container'
    ).render();
